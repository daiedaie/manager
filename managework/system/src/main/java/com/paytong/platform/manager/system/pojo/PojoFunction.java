package com.paytong.platform.manager.system.pojo;
...
public class PojoFunction implements java.io.Serializable {
	...
	private List<PojoFunction> children;
	...
	@Transient
	public List<PojoFunction> getChildren() {
		return children;
	}

	public void setChildren(List<PojoFunction> children) {
